...
public class SavingServiceImpl implements SavingService {
	...
	public int setSavingSignup(SavingVO vo) {
		...
		//System.out.println("startDate : " + startDate); // 현재날짜
		//System.out.println("startDateString : " + startDate); // String으로 변환

		if (paymentPeriod == 6) {
		    expiryDate = startDate.plusMonths(6);
		    //System.out.println("expiryDate6 : " + expiryDate);
		}
		else if (paymentPeriod == 12) {
	    expiryDate = startDate.plusMonths(12);
	    //System.out.println("expiryDate12 : " + expiryDate);
		}
		else if (paymentPeriod == 24) {
	    expiryDate = startDate.plusMonths(24);
	    //System.out.println("expiryDate24 : " + expiryDate);
		}
		else {
		...
		//System.out.println("만기일: " + expiryDateString);
		...
		if(vo.getSavingSw().equals("Y")) {
			...
			//System.out.println("savingSw1 : " + vo.getSavingSw());
			//System.out.println("interestY : " + vo.getInterest());
		}
		else { 
			double total_deposit = 0.0;
			if(vo.getPaymentPeriod() == 12) {
				total_deposit = vo.getAmount()*12;
				//System.out.println("total_deposit(12) : " + total_deposit);
			}
			else if(vo.getPaymentPeriod() == 24) {
				total_deposit = vo.getAmount()*24;
				//System.out.println("total_deposit(24) : " + total_deposit);
			}
			else {
				total_deposit = vo.getAmount()*36;
				//System.out.println("total_deposit(36) : " + total_deposit);
			}
			interest = 2.8;
			vo.setInterest(interest);
			vo.setTotal_deposit(total_deposit);
			//System.out.println("savingSw2 : " + vo.getSavingSw());
			//System.out.println("interestJ : " + vo.getInterest());
		}
		...
		if(vo.getSavingSw().equals("Y")) {
			if(vo.getPaymentPeriod() == 6) {
				...
				//System.out.println("interest : " + vo.getAmount()*0.025/2);
				...
				vo.setTotalAmount(totalAmount);
				//System.out.println("interest : " + vo.getAmount()*0.025);
				//System.out.println("totalAmount : " + totalAmount);
				//System.out.println("amount : " + vo.getAmount());
			}
			else {
		...
		// 적금일때
			...
			if(vo.getPaymentPeriod() == 12) {
				...
				// 12회차 : 원금 * 이자 *  1/12
				/*
				amountM = vo.getAmount() * 0.028 * 12/12;
				System.out.println("amountM(1) : " + amountM);
				
				amountM = vo.getAmount() * 0.028 * 11/12;
				System.out.println("amountM(2) : " + Math.floor(amountM));
				
				amountM = vo.getAmount() * 0.028 * 10/12;
				System.out.println("amountM(3) : " + Math.floor(amountM));
				*/
				...
				vo.setTotalAmount(totalAmount);
				//System.out.println("totalAmount(원금+이자) : " + totalAmount); // 1,218,200
				//System.out.println("totInterestJ(이자 총합 18,200) : " + totInterestJ);
			}
				...
				for (int i = 24; i >= 1; i--) {
					interestJ = vo.getAmount() * 0.028 * i / 12;
					totInterestJ += interestJ;
					//System.out.println("interestJ(" + (25 - i) + ") : " + Math.floor(interestJ));
				}
				totalAmount = vo.getAmount()*24 + totInterestJ;
				vo.setTotalAmount(totalAmount);
				//System.out.println("totalAmount(원금 + 이자) : " + totalAmount);
				//System.out.println("totInterestJ(이자 총합 70,000) : " + totInterestJ);
			}
				...
				vo.setTotalAmount(totalAmount);
				//System.out.println("totalAmount(원금 + 이자) : " + totalAmount);
				//System.out.println("totInterestJ(이자 총합 155,400) : " + totInterestJ);
			}
		}
		...
		if(vo.getSavingSw().equals("Y")) {
			if(vo.getPaymentPeriod() == 6) {
				...
				//System.out.println("totInterestJ (18,200) : " + totInterestJ);
				tax = Math.round(totInterestJ * 0.154);
				//System.out.println("tax (2,803) : " + tax);
				...
				vo.setExpectedTax(tax);
					...
					//System.out.println("totInterestJ (70,000) : " + totInterestJ);
					tax = Math.round(totInterestJ * 0.154);
					//System.out.println("tax (10,780) : " + tax);
					vo.setExpectedInterest(totInterestJ);
					vo.setExpectedTax(tax);
				}
				else {
					...
					//System.out.println("totInterestJ (155,400) : " + totInterestJ);
					tax = Math.round(totInterestJ * 0.154);
					//System.out.println("tax (23,932) : " + tax);
					vo.setExpectedInterest(totInterestJ);
					vo.setExpectedTax(tax);
				}
		}
		...
		// 세후 실수령액
		//vo.getTotalAmount() - vo.getExpectedTax();
		//System.out.println("총액" + vo.getTotalAmount());
		//System.out.println("세금" + vo.getExpectedTax());
