            ...
            eventClick: function(info) {
                if (confirm('정말로 이 일정을 삭제하시겠습니까?')) {
                    ...
                    var options = { 
                    	...
                    	var start = new Date(info.event.start).toLocaleString('en-US', options);
                    	var end = info.event.end ? new Date(info.event.end).toLocaleString('en-US', options) : null;
